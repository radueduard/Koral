...
// which is why a project that uses meshes has nothing to configure. The exported entry points are
// the other route in, for a runtime that loads the module by name.

#include "meshModule.h"

// No dependencies — vertex formats need nothing but the engine.
KORAL_DECLARE_MODULE(kmesh::MeshModule)
