...
namespace gfx::vk
{
    ...
    public:
        ...
        gfx::CommandBuffer& DispatchIndirect(gfx::ResourceRef<gfx::Buffer> indirectBuffer, glm::u64 offset) override;
        ...
        gfx::CommandBuffer& DrawIndirect(gfx::ResourceRef<gfx::Buffer> indirectBuffer, glm::u64 offset, glm::u32 drawCount, glm::u32 stride) override;
        gfx::CommandBuffer& DrawIndexedIndirect(gfx::ResourceRef<gfx::Buffer> indirectBuffer, glm::u64 offset, glm::u32 drawCount, glm::u32 stride) override;
        gfx::CommandBuffer& DrawMeshTasksIndirect(gfx::ResourceRef<gfx::Buffer> indirectBuffer, glm::u64 offset, glm::u32 drawCount, glm::u32 stride) override;
